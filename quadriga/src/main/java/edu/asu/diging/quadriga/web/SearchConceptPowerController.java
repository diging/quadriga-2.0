...
public class SearchConceptPowerController {
    ...
    public ResponseEntity<ConceptPowerSearchResults> searchConcepts(@RequestParam("searchTerm") String searchTerm,
            @RequestParam(defaultValue = "1", required = false, value = "page") int page) {
        ConceptPowerSearchResults searchResults = conceptPowerService.searchConcepts(searchTerm, page);
