...
public class GraphCreationServiceImplTest {
    ...
    public void test_createGraph_nestedEventGraph_success() {
        ...
        Assert.assertEquals("be identical to; be someone or something; \"The president of the company is John Smith\"; \"This is my house\"", predicateNode2.getDescription());
        Assert.assertEquals("Elsa Einstein was the second wife and cousin of Albert Einstein", objectNode.getDescription());
        ...
        Assert.assertArrayEquals(new String[] {
                "http://www.digitalhps.org/concepts/cousin",
                "http://www.digitalhps.org/concepts/cousin-2"
                }, subjectNode2.getAlternativeUris().toArray());
        Assert.assertArrayEquals(new String[] {
                "http://www.digitalhps.org/concepts/be",
                "http://www.digitalhps.org/concepts/be-2"
    ...
    public void test_createSubjectOrObjectNode_testUniqueNodesDoesntContain() {
        ...
        AppellationEvent subject = (AppellationEvent)((RelationEvent)(sampleEventGraphLists.get(0)
                .get(0)
                .getRootEvent()))
                .getRelation()
                .getSubject();
        graphCreationServiceImpl.createSubjectOrObjectNode(nodes, subject, uniqueNodes, GraphNodeType.SUBJECT, new ObjectId().toString());
    ...
    public void test_createSubjectOrObjectNode_testUniqueNodesContains() {
        ...
        graphCreationServiceImpl.createSubjectOrObjectNode(nodes, subject, uniqueNodes, GraphNodeType.SUBJECT, eventGraphId2.toString());
    ...
    private static void createSampleConceptCache() {
        ...
        subject2.setAlternativeUris(Arrays.asList(
                "http://www.digitalhps.org/concepts/cousin",
                "http://www.digitalhps.org/concepts/cousin-2"));
        ...
        predicate2.setDescription("be identical to; be someone or something; \"The president of the company is John Smith\"; \"This is my house\"");
        predicate2.setAlternativeUris(Arrays.asList(
                "http://www.digitalhps.org/concepts/be",
                "http://www.digitalhps.org/concepts/be-2"));
    }
